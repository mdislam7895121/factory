...
/**
 * {{screenName}} - Form Screen
 * Generated from spec: {{featureId}}/{{version}}
 * 
 * Form for creating or editing {{singular}} items.
 */
export default function {{screenName}}({ navigation, route }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = isEdit
        ? await {{camelCaseFeature}}Api.update(route.params.id, formData)
        : await {{camelCaseFeature}}Api.create(formData);
